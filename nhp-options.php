...
//Setup custom links in the footer for share icons
    ...
    $args['share_icons']['rankexecutives'] = array(
        'link' => 'http://rankexecutives.com',
        'title' => 'Visit RankExecutives.com',
        'img' => NHP_OPTIONS_URL.'img/glyphicons/glyphicons_350_rankexecutives.png'
    );
...
//Choose a custom option name for your theme options, the default is the theme name in lowercase with spaces replaced by underscores
    $args['opt_name'] = 'the_fresh_deli_executive_options';
...
//Set the Help Sidebar for the options page - no sidebar by default										
    ...
    $sections[] = array(
                    ...
                    'desc' => __('<p class="description">Adjust general settings such as: upload custom logo images, upload custom fonts, and much more.</p>', 'nhp-opts'),
                    //all the glyphicons are included in the options folder, so you can hook into them, or link to your own custom ones.
                    //You dont have to though, leave it blank for default.
                    //'icon' => NHP_OPTIONS_URL.'img/glyphicons/glyphicons_062_attach.png'
                    'icon' => 'options-icon-general',
                    //Lets leave this as a blank section, no options just some intro text set above.
                    'fields' =>  array(
                                    array(
                                        'id' => 'theme-logo',
